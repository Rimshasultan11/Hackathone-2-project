...
const Hero = () => {
  return (
    <div className="wrapper w-full h-auto md:h-[704px] bg-[#FFFFFF]">
      <div className="mt-[60px] mx-[20px] md:mx-[80px] h-auto md:h-[584px] flex flex-col md:flex-row bg-[#2A254B]">
        {/* Text Section */}
        <div className="mt-[60px] mx-[20px] md:mx-[70px] w-full md:w-[513px] text-center md:text-left">
          <p className="text-white px-4 py-10 font-normal font-sans text-4xl leading-10">
